...
Agent-only project context for BNI/BIONS sentiment monitoring.
...
Do not treat `.agents/` as user-facing product docs. It is operating context for coding agents.
